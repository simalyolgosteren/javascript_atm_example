    ...
    if (!sifreGirildi) {
        ...
        if (birinciDeger === 1) {
            ...
            if (hizliCekim === 1) {
                ...
                console.log("Hesabınızda Kalan Bakiye:", hesap);
                ...
                console.log("Hesabınızdaki Kalan Bakiye:", hesap);
            ...
            const hesapNo = prompt("Havale Yapmak İstediğiniz Hesap No girin");
            if (hesapNo === "12345678") {
                console.log("Hesabın Sahibinin İsmi: Ayşe");
                const havaleMiktari = parseInt(prompt("Lütfen Miktar Gir"));
                if (havaleMiktari > 0) {
                    hesap -= havaleMiktari;
                    console.log("Aysenin Hesabına:", havaleMiktari, "Tl Gönderilmiştir");
            ...
            const vadeliMiktar = parseInt(prompt("Lütfen Aktarılcak Miktarı Giriniz:"));
            hesap -= vadeliMiktar;
            ...
            console.log(vadeliHesap);
        } else if (birinciDeger === 6) {
            const krediMiktari = parseInt(prompt("Çekmek istediğiniz kredi miktarını giriniz:"));
            if (krediMiktari > 0) {
                ...
                if (krediHesabi >= krediMiktari) {
                    ...
                    console.log("Kredi miktarı hesabınızda yeterli bakiye bulunmadığı için kredi çekme işlemi gerçekleştirilemedi.");
                }
            } else {
                console.log("Hatalı Giriş");
            }
